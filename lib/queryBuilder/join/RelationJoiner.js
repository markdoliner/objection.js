...
class RelationJoiner {
  ...
  fetchColumnInfo(builder) {
    ...
    // TODO: Need to use something like Promise.allSettled() to ensure
    // all metadatal lookup promises finish evaluating because it's
    // important for their error handler to run to remove the cached
    // rejected promise.
    return mapPromise(
